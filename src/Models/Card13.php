...
/**
 * The expirationMonth, expirationYear and securityCode is sent to the issuer as part of network token
 * enrollment and is not stored under the Instrument Identifier.
 */
class Card13 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the Card13 object to a human-readable string representation.
     *
     * @return string The string representation of the Card13 object.
     */
