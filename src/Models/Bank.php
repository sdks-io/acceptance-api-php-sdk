...
class Bank implements \JsonSerializable
{
    ...
    /**
     * Converts the Bank object to a human-readable string representation.
     *
     * @return string The string representation of the Bank object.
     */
    ...
    protected $propertyNames = ['account', 'routingNumber', 'iban', 'swiftCode', 'code'];
