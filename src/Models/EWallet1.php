...
class EWallet1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the EWallet1 object to a human-readable string representation.
     *
     * @return string The string representation of the EWallet1 object.
     */
    ...
    protected $propertyNames = ['fundingSource', 'accountId'];
