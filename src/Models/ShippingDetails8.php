...
class ShippingDetails8 implements \JsonSerializable
{
    /**
     * @var bool|null
     */
    ...
    /**
     * Converts the ShippingDetails8 object to a human-readable string representation.
     *
     * @return string The string representation of the ShippingDetails8 object.
     */
    ...
    protected $propertyNames = ['giftWrap', 'shippingMethod'];
