...
class Watchlistscreening implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the Watchlistscreening object to a human-readable string representation.
     *
     * @return string The string representation of the Watchlistscreening object.
     */
