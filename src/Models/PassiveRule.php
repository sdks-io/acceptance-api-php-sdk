 ...
 */
class PassiveRule implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PassiveRule object to a human-readable string representation.
     *
     * @return string The string representation of the PassiveRule object.
     */
