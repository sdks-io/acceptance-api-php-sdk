...
class SubMerchant implements \JsonSerializable
{
    ...
    /**
     * Sets Card Acceptor Id.
     * Unique identifier assigned by the payment card company to the sub-merchant.
     *
     * @maps cardAcceptorId
     */
    public function setCardAcceptorId(?string $cardAcceptorId): void
    {
    ...
    {
        $json = [];
        if (isset($this->cardAcceptorId)) {
            $json['cardAcceptorId']     = $this->cardAcceptorId;
        }
        if (isset($this->id)) {
            $json['id']                 = $this->id;
        }
