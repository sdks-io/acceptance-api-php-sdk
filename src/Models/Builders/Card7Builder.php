...
class Card7Builder
{
    ...
    private function __construct(Card7 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Card 7 Builder object.
     */
    public static function init(): self
    {
        return new self(new Card7());
    }
    ...
    /**
     * Initializes a new Card 7 object.
     */
    public function build(): Card7
    {
