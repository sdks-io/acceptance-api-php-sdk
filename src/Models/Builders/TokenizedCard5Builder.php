...
/**
 * Builder for model TokenizedCard5
 *
 * @see TokenizedCard5
 */
class TokenizedCard5Builder
{
    /**
     * @var TokenizedCard5
     */
    ...
    private function __construct(TokenizedCard5 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Tokenized Card 5 Builder object.
     */
    public static function init(): self
    {
        return new self(new TokenizedCard5());
    }
    ...
    /**
     * Initializes a new Tokenized Card 5 object.
     */
    public function build(): TokenizedCard5
    {
