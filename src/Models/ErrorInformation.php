...
class ErrorInformation implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ErrorInformation object to a human-readable string representation.
     *
     * @return string The string representation of the ErrorInformation object.
     */
