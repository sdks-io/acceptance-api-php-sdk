...
class VisaAcceptanceMergedSpecClientBuilder
{
    /**
     * @var array
     */
    ...
    public function acceptCredentials(AcceptCredentialsBuilder $accept): self
    {
        $this->config = array_merge($this->config, $accept->getConfiguration());
        return $this;
    }
    ...
    public function build(): VisaAcceptanceMergedSpecClient
    {
        return new VisaAcceptanceMergedSpecClient($this->config);
    }
}
