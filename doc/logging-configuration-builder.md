...
The following example uses `Monolog\Logger` implementation of `Psr\Log\LoggerInterface` for VisaAcceptanceMergedSpecClient initialization.
...
$logger = new Logger('VisaAcceptanceMergedSpec');
