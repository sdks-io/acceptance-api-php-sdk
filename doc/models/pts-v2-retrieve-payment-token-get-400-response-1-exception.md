...
# Pts V2 Retrieve Payment Token Get 400 Response 1 Exception
...
| `reason` | `?string` | Optional | The reason of the status.<br><br>Possible values:<br><br>- INVALID_DATA<br>- RESOURCE_NOT_FOUND | getReason(): ?string | setReason(?string reason): void |
