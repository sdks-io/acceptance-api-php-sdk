...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\MerchantDefinedSecureInformationBuilder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$merchantDefinedSecureInformation = MerchantDefinedSecureInformationBuilder::init()
    ->secure1('secure12')
    ->secure2('secure24')
    ->secure3('secure30')
    ->secure4('secure44')
