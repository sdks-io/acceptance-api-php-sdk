...
| `lineItems` | [`?(LineItem3[])`](../../doc/models/line-item-3.md) | Optional | - | getLineItems(): ?array | setLineItems(?array lineItems): void |
...
$orderInformation6 = OrderInformation6Builder::init()
    ->amountDetails(
