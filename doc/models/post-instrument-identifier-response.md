...
# Post Instrument Identifier Response
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PostInstrumentIdentifierResponseBuilder;
...
$postInstrumentIdentifierResponse = PostInstrumentIdentifierResponseBuilder::init()
    ->links(
        Links21Builder::init()
            ->self(
                Self20Builder::init()
