...
# Post Payment Instrument Request
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PostPaymentInstrumentRequestBuilder;
...
$postPaymentInstrumentRequest = PostPaymentInstrumentRequestBuilder::init()
    ->links(
        Links20Builder::init()
            ->self(
                Self19Builder::init()
