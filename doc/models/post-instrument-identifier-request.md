...
# Post Instrument Identifier Request
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PostInstrumentIdentifierRequestBuilder;
...
$postInstrumentIdentifierRequest = PostInstrumentIdentifierRequestBuilder::init()
    ->links(
        Links21Builder::init()
            ->self(
                Self20Builder::init()
