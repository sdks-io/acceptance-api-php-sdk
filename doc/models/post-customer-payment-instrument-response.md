...
# Post Customer Payment Instrument Response

*This model accepts additional fields of type array.*

## Structure

`PostCustomerPaymentInstrumentResponse`
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PostCustomerPaymentInstrumentResponseBuilder;
...
$postCustomerPaymentInstrumentResponse = PostCustomerPaymentInstrumentResponseBuilder::init()
    ->links(
        Links20Builder::init()
            ->self(
                Self19Builder::init()
