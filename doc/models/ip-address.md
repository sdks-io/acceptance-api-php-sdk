...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\IpAddressBuilder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$ipAddress = IpAddressBuilder::init()
    ->anonymizerStatus('anonymizerStatus0')
    ->locality('locality0')
    ->country('country4')
    ->administrativeArea('administrativeArea6')
    ->routingMethod('routingMethod0')
