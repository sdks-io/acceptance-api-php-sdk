...
# Client Reference Information 28
...
| `partner` | [`?Partner`](../../doc/models/partner.md) | Optional | - | getPartner(): ?Partner | setPartner(?Partner partner): void |
...
$clientReferenceInformation28 = ClientReferenceInformation28Builder::init()
    ->code('code6')
    ->reconciliationId('reconciliationId0')
    ->pausedRequestId('pausedRequestId4')
