...
# Patch Instrument Identifier Response

*This model accepts additional fields of type array.*

## Structure

`PatchInstrumentIdentifierResponse`
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchInstrumentIdentifierResponseBuilder;
...
$patchInstrumentIdentifierResponse = PatchInstrumentIdentifierResponseBuilder::init()
    ->links(
        Links21Builder::init()
            ->self(
                Self20Builder::init()
