...
# Post Customer Shipping Address Response

*This model accepts additional fields of type array.*

## Structure

`PostCustomerShippingAddressResponse`
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PostCustomerShippingAddressResponseBuilder;
...
$postCustomerShippingAddressResponse = PostCustomerShippingAddressResponseBuilder::init()
    ->links(
        Links27Builder::init()
            ->self(
                Self26Builder::init()
