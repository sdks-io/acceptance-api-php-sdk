...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchCustomerResponseBuilder;
...
$patchCustomerResponse = PatchCustomerResponseBuilder::init()
    ->links(
        Links19Builder::init()
            ->self(
                Self18Builder::init()
