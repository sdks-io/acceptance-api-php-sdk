...
# Patch Customer Payment Instrument Request
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchCustomerPaymentInstrumentRequestBuilder;
...
$patchCustomerPaymentInstrumentRequest = PatchCustomerPaymentInstrumentRequestBuilder::init()
    ->links(
        Links20Builder::init()
            ->self(
                Self19Builder::init()
