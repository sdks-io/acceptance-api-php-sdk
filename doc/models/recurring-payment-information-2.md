...
# Recurring Payment Information 2
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\RecurringPaymentInformation2Builder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$recurringPaymentInformation2 = RecurringPaymentInformation2Builder::init(
    'endDate6',
    8
)
    ->numberOfPayments(204)
    ->originalPurchaseDate('originalPurchaseDate4')
    ->sequenceNumber(76)
    ->type('type4')
