...
The completeMandate object is designed to provide instructions for orchestrating payment services.  Unified Checkout is capable of orchestrating a number of services on your behalf.<br><br>  
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\CompleteMandateBuilder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$completeMandate = CompleteMandateBuilder::init()
    ->type('AUTH')
