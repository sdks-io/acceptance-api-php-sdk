...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchPaymentInstrumentRequestBuilder;
...
$patchPaymentInstrumentRequest = PatchPaymentInstrumentRequestBuilder::init()
    ->links(
        Links20Builder::init()
            ->self(
                Self19Builder::init()
