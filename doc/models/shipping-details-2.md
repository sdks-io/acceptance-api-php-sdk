...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\ShippingDetails2Builder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$shippingDetails2 = ShippingDetails2Builder::init()
    ->giftWrap(false)
    ->shippingMethod('shippingMethod8')
    ->shipFromPostalCode('shipFromPostalCode0')
