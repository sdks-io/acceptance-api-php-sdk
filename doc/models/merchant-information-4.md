...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\MerchantInformation4Builder;
use VisaAcceptanceMergedSpecLib\Models\Builders\MerchantDescriptorBuilder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$merchantInformation4 = MerchantInformation4Builder::init()
    ->merchantDescriptor(
    ...
    ->cardAcceptorReferenceNumber('cardAcceptorReferenceNumber0')
    ->taxId('taxId6')
    ->additionalProperty('exampleAdditionalProperty', ApiHelper::deserialize('{"key1":"val1","key2":"val2"}'))
    ->build();
```
