...
# Patch Customers Shipping Address Response

*This model accepts additional fields of type array.*

## Structure

`PatchCustomersShippingAddressResponse`
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchCustomersShippingAddressResponseBuilder;
...
$patchCustomersShippingAddressResponse = PatchCustomersShippingAddressResponseBuilder::init()
    ->links(
        Links27Builder::init()
            ->self(
                Self26Builder::init()
