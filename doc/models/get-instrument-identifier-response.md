...
# Get Instrument Identifier Response

*This model accepts additional fields of type array.*

## Structure

`GetInstrumentIdentifierResponse`
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\GetInstrumentIdentifierResponseBuilder;
...
$getInstrumentIdentifierResponse = GetInstrumentIdentifierResponseBuilder::init()
    ->links(
        Links21Builder::init()
            ->self(
                Self20Builder::init()
