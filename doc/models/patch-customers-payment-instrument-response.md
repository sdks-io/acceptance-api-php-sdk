...
# Patch Customers Payment Instrument Response

*This model accepts additional fields of type array.*

## Structure

`PatchCustomersPaymentInstrumentResponse`
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchCustomersPaymentInstrumentResponseBuilder;
...
$patchCustomersPaymentInstrumentResponse = PatchCustomersPaymentInstrumentResponseBuilder::init()
    ->links(
        Links20Builder::init()
            ->self(
                Self19Builder::init()
