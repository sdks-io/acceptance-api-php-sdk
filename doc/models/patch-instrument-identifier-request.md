...
# Patch Instrument Identifier Request
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchInstrumentIdentifierRequestBuilder;
...
$patchInstrumentIdentifierRequest = PatchInstrumentIdentifierRequestBuilder::init()
    ->links(
        Links21Builder::init()
            ->self(
                Self20Builder::init()
