...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\OrderBuilder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$order = OrderBuilder::init()
    ->totalAmount('totalAmount0')
    ->currency('currency6')
    ->subTotalAmount('subTotalAmount6')
    ->handlingAmount('handlingAmount6')
    ->shippingAmount('shippingAmount0')
