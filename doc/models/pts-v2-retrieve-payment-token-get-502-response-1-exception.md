...
# Pts V2 Retrieve Payment Token Get 502 Response 1 Exception
...
| `reason` | `?string` | Optional | The reason of the status.<br><br>Possible values:<br><br>- INTERNAL_SERVER_ERROR | getReason(): ?string | setReason(?string reason): void |
