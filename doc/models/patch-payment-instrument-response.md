...
`PatchPaymentInstrumentResponse`
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchPaymentInstrumentResponseBuilder;
...
$patchPaymentInstrumentResponse = PatchPaymentInstrumentResponseBuilder::init()
    ->links(
        Links20Builder::init()
            ->self(
                Self19Builder::init()
