...
# Pts V2 Payments Voids Post 400 Response 1 Exception

*This model accepts additional fields of type array.*

## Structure

`PtsV2PaymentsVoidsPost400Response1Exception`
...
| `reason` | `?string` | Optional | The reason of the status.<br><br>Possible values:<br><br>- MISSING_FIELD<br>- INVALID_DATA<br>- DUPLICATE_REQUEST<br>- INVALID_MERCHANT_CONFIGURATION<br>- NOT_VOIDABLE<br>- NOT_SUPPORTED | getReason(): ?string | setReason(?string reason): void |
