...
# Client Reference Information 1
...
$clientReferenceInformation1 = ClientReferenceInformation1Builder::init()
    ->code('code8')
    ->submitLocalDateTime('submitLocalDateTime6')
    ->ownerMerchantId('ownerMerchantId6')
