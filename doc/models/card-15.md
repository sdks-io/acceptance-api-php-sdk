...
| `maxLength` | `?string` | Optional | This field contains the max length of the card.<br><br>**Constraints**: *Maximum Length*: `2` | getMaxLength(): ?string | setMaxLength(?string maxLength): void |
| `credentialType` | `?string` | Optional | This field contains the type of the payment credential.<br>Possible values:<br><br>- PAN<br>- TOKEN<br><br>**Constraints**: *Maximum Length*: `5` | getCredentialType(): ?string | setCredentialType(?string credentialType): void |
| `brands` | [`?(Brand[])`](../../doc/models/brand.md) | Optional | Array of brands | getBrands(): ?array | setBrands(?array brands): void |
