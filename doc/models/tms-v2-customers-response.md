...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\TmsV2CustomersResponseBuilder;
...
$tmsV2CustomersResponse = TmsV2CustomersResponseBuilder::init()
    ->links(
        Links19Builder::init()
            ->self(
                Self18Builder::init()
