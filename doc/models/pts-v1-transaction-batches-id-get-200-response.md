...
# Pts V1 Transaction Batches Id Get 200 Response
...
| `links` | [`?Links14`](../../doc/models/links-14.md) | Optional | - | getLinks(): ?Links14 | setLinks(?Links14 links): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PtsV1TransactionBatchesIdGet200ResponseBuilder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$ptsV1TransactionBatchesIdGet200Response = PtsV1TransactionBatchesIdGet200ResponseBuilder::init()
    ->id('psy8s1d')
