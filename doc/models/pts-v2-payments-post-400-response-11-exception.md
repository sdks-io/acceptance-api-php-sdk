...
# Pts V2 Payments Post 400 Response 11 Exception

*This model accepts additional fields of type array.*

## Structure

`PtsV2PaymentsPost400Response11Exception`
...
| `reason` | `?string` | Optional | The reason of the status.<br><br>Possible values:<br><br>- MISSING_FIELD<br>- INVALID_DATA<br>- DUPLICATE_REQUEST<br>- INVALID_CARD<br>- CARD_TYPE_NOT_ACCEPTED<br>- INVALID_MERCHANT_CONFIGURATION<br>- PROCESSOR_UNAVAILABLE<br>- INVALID_AMOUNT<br>- INVALID_CARD_TYPE<br>- INVALID_PAYMENT_ID<br>- NOT_SUPPORTED | getReason(): ?string | setReason(?string reason): void |
