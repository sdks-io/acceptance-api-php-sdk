...
# Patch Customer Shipping Address Request
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PatchCustomerShippingAddressRequestBuilder;
...
$patchCustomerShippingAddressRequest = PatchCustomerShippingAddressRequestBuilder::init()
    ->links(
        Links27Builder::init()
            ->self(
                Self26Builder::init()
