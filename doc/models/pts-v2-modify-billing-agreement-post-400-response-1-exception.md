...
# Pts V2 Modify Billing Agreement Post 400 Response 1 Exception
...
| `reason` | `?string` | Optional | The reason of the status.<br><br>Possible values:<br><br>- MISSING_FIELD<br>- INVALID_DATA<br>- DUPLICATE_REQUEST<br>- INVALID_MERCHANT_CONFIGURATION<br>- PROCESSOR_UNAVAILABLE | getReason(): ?string | setReason(?string reason): void |
