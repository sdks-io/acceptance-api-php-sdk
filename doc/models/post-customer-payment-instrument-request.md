...
# Post Customer Payment Instrument Request
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\PostCustomerPaymentInstrumentRequestBuilder;
...
$postCustomerPaymentInstrumentRequest = PostCustomerPaymentInstrumentRequestBuilder::init()
    ->links(
        Links20Builder::init()
            ->self(
                Self19Builder::init()
