...
| `businessNameEnglish` | `?string` | Optional | Business name in English characters. This field is supported only on JCN Gateway and for the Sumitomo Mitsui Card Co. acquirer on Visa Acceptance through VisaNet.<br><br>**Constraints**: *Maximum Length*: `25` | getBusinessNameEnglish(): ?string | setBusinessNameEnglish(?string businessNameEnglish): void |
...
```php
use VisaAcceptanceMergedSpecLib\Models\Builders\JapanPaymentOptions2Builder;
use VisaAcceptanceMergedSpecLib\ApiHelper;

$japanPaymentOptions2 = JapanPaymentOptions2Builder::init()
    ->paymentMethod('paymentMethod2')
    ->terminalId('terminalId2')
    ->businessName('businessName2')
    ->businessNameKatakana('businessNameKatakana6')
    ->businessNameEnglish('businessNameEnglish0')
